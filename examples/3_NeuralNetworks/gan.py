...
# Generator
def generator(x):
    print('generate_input.shape', x.shape)
    ...
    print('generate_output.shape', out_layer.shape)
    return out_layer


# Discriminator
def discriminator(x):
    print('discriminator_input.shape', x.shape)
    ...
    out_layer = tf.nn.sigmoid(out_layer)
    print('discriminator_output.shape', out_layer.shape)
    return out_layer
